...
Plan (authoritative detail): docs/superpowers/plans/2026-09-08-methodology-roles-update.md — Task 3

## Scope
Execute plan Task 3 exactly as written, all steps in order.
