...
|---|---|---|---|
| T-001 | Spec A: sd-superpowers methodology update (role cast, foreman role, process changes) | #1 | review |
| T-002 | Spec C: documentation + ticketing standard (shared schema, PulseMark-derived) | #1 | review |
